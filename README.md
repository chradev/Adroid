...
### A short video of PT head movement using geared stepper motors controled by RPi Pico's PIO
...
## 3D printed unified details and latest wide mount variant with own wheel design
