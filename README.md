...
<img src="https://github.com/chradev/Adroid/blob/main/assets/configs/ProtoDesk-06.png?raw=true" width="100%" align="center" alt="Adroid robots" title="&shy;&#8197;       the Small, the Tall, the Wide, the Smart &#013;      Малкият, Високият, Широкият, Умният &#013;(Дребосъкът, Дангалакът, Дебелакът, Добрякът)">
...
<tr >
    ...
    <th width="18%" style="text-align: center;"> <img src="https://github.com/chradev/Adroid/blob/main/assets/theSmart-06.png?raw=true" width="auto" height="240px" ></th></tr>
</thead><tbody>
<tr >
